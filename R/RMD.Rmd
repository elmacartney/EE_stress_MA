...
VCV_Eb <- impute_covariance_matrix(vi = dat$lnRRV_Eb, cluster = dat$Study_ID, r = 0.5)
VCV_Sb <- impute_covariance_matrix(vi = dat$lnRRV_Sb, cluster = dat$Study_ID, r = 0.5)
VCV_ESb <- impute_covariance_matrix(vi = dat$lnRRV_ESb, cluster = dat$Study_ID, r = 0.5)
...
#ggsave(file = "./figs/Alluvial_diagram_v2.pdf", width = 10, height = 12, units = "cm", dpi = 300, scale = 2) #, device = cairo_pdf)
```

**Fig. S2** The combined plot of all alluvial diagram used to make Fig. 2 in the main text
...
```{r}
mod_E0b <- rma.mv(yi = lnRR_E_b, V = VCV_Eb, random = list(~1|Study_ID,
                                                         ~1|ES_ID, 
                                                         ~1|Strain),
                 test = "t",
                 data = dat)
...
#### Using untransformed percent data
```{r}
mod_S0b <- rma.mv(yi = lnRR_S_b, V = VCV_Sb, random = list(~1|Study_ID,
                                                         ~1|ES_ID, 
                                                         ~1|Strain),
                 test = "t",
                 data = dat)
...
```{r}
mod_ES0b <- rma.mv(yi = lnRR_ES_b, V = VCV_ESb, random = list(~1|Study_ID,
                                                         ~1|ES_ID, 
                                                         ~1|Strain),
                 test = "t",
                 data = dat)
