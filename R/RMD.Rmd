...
```
Note that I checked the top four most positive ES and the data looks correct.
...
Im not sure why the second highest one is like (ES 16) that as the control indivs do the best. EE indivs do best in the 3rd highest ES (ES 10). 
