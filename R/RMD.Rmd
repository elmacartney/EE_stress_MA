...
# TODO - please do the rest
dat <- dat %>% mutate(CC_mean = if_else(ES_ID == 36,  CC_mean+29.4, CC_mean),
                      CS_mean = if_else(ES_ID == 36,  CC_mean+29.4, CS_mean),
                      EC_mean = if_else(ES_ID == 36,  CC_mean+29.4, EC_mean),
                      ES_mean = if_else(ES_ID == 36,  CC_mean+29.4, ES_mean))
  
# testing
dat$CC_mean # try to do it your code below


# TODO Erin - this is not working (I do not think this is how you use case_when-this is used when you have different categories of things)
# TODO Erin -you need to learn how to test your code is working - you need to make a habit of it (TESTIN crutial important)
# TODO - I will teach what you mena next - really important process which you should have pick up early in your R career (doing this and not doing will make a huge difference - once learn, you will solve 80% of problems and also better at asking R questions)  
# TODO - it was easy to find this miskate as - I jsut did "dat$CC_mean" - it was all NA
...
#TODO this VCV doesn't run in models
...
# this will not work for impute_cavaraince_matrix - this is a different format
# TODO explain Erin - why this is good but not that useful
