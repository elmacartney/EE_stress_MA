...
- rounding down sample sizes that are reported as decimals due to averaging n across treatments (rounding down is more conservative),
...
```
**Fig.1** Visual of missing data for each column. Note that most missing data are for different descriptive statistics and papers are often not consistent with the types of descriptive statistics reported (i.e., SD, SE, mean, median etc)
...
p4
```
**Fig. 2c** Relationship/nestedness between if the assay measured a learning or memory trait, the type of assay used, and the type of reinforcement used
...
orchard1
```
**Fig. 3** Orchard plot showing meta-analytic mean and 95% confidence interval (think black line) and 95% prediction interval (thin black line) for the main effects of environmental enrichment and stress, and the interactive effect. Individuals points show observed effect sizes and sample sizes. 
