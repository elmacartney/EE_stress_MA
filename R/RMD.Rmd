...
dat$e_n <- with(dat, (4*(((CC_mean + EC_mean)/2) * ((ES_mean + CS_mean)/2)) / (((CC_mean + EC_mean)/2) + ((ES_mean + CS_mean)/2))))

#dat$e_n <- with(dat, (4*(C_N*T_N)) / (C_N + T_N))
#funnel(dat$lnRR_S, dat$lnRRV_S, ni = dat$e_n, yaxis="ni",
 #      #xlim = c(-3, 3),
