...
dat$inv_e_n_S <- 1/(dat$e_n_S/4) #use this if sqrt_inv_e_n_S is significant
...
#Do with key moderators 'full model' including publication year

#time lag bias
#unimoderator
dat$Year_published <- as.vector(scale(dat$Year_published, scale = F))

timelag_S_uni <- rma.mv(lnRR_Sa, lnRRV_S, mods = ~1 + sqrt_inv_e_n_S +  Year_published + XXXX + XXX, random = list(~1|Study_ID,
                                                          ~1|ES_ID,
