...
Funnel plot using effective sample size rather than precision. 
Unimoderator time-lag bias. 
...
#TODO: I don't really understand this code in the github file 
...
ggplot(MA_CVR) +
  ...
  xlab("Animal group left out") + 
  ylab("SMD [Cohen's d]  ą 95% CI") + 
  coord_flip() +
