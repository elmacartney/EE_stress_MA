...
- calculating pair-wise contrasts between moderators
...
We ran a multi-moderator ‘full’ model of all moderators. We ran model selection based on AIC and selected the top top set of models within delta AIC of 6 and calculated the importance of each moderator (i.e., Akaike weights) within this top model set.
